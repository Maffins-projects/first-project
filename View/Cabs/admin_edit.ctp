...
<?php echo $this->Form->create('Cab'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Cab'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Cab.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Cab.id'))); ?></li>
