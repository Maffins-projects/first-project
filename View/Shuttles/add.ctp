...
<table>
 ...
 <table>
      ...
      <td>
        <table class="content-table">
          ...
          <tr>
            ...
            <?php $options = array('0'=>"-Select-", 'creditcard'=>'Credit Card', 'eft'=>'EFT', 'directdeposit'=>'Direct Deposit', 'Cash'=>'Cash Payment');?>
            <td><?php echo $this->Form->select('payment_method',$options, array('label'=>false)); ?></td>
          </tr>
          ...
          <tr>
            <td><label for="name">Flight Number :</label> </td>
            <td><?php echo $this->Form->input('pickup_flight_number', array('label'=>false)); ?></td>
          </tr>      
          <tr>
            <td><label for="name">Date :</label> </td>
            <td><?php echo $this->Form->input('pickup_datetime', array('label'=>false, 'type'=>'text')); ?></td>
          </tr>     
          <tr>
            <td colspan="2" style="text-align: center;background-color: #F2F2F2;font-weight: bold;text-align: center;">
            Drop off point
          ...
          <tr>
            <td><label for="name">Flight Number :</label> </td>
            <td><?php echo $this->Form->input('to_flight_number', array('label'=>false)); ?></td>
          </tr>      
          <tr>
            <td><label for="name">Date :</label> </td>
            <td><?php echo $this->Form->input('to_datetime', array('label'=>false, 'type'=>'text')); ?></td>
          </tr>        
          <tr>
    ...
    <td valign="top">
      <h2>Send me free Shuttle quotes now </h2>
   <br />
Complete your details. It is important that you ensure the information supplied is correct so that shuttle companies can contact you quickly and easily about your requirements. Your request is obligation and cost free!
      <br />
      <br />
        <img src="/removal-leads.co.za/img/airport-shuttle-service.jpg" style="width:443px" alt="Removals, shuttle services, cab">    
    </td>
  </tr>
</table>  
</div>   
