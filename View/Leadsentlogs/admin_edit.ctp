...
<?php echo $this->Form->create('Leadsentlog'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Leadsentlog'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Leadsentlog.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Leadsentlog.id'))); ?></li>
