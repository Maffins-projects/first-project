...
<?php echo $this->Form->create('SaveLead'); ?>
  ...
  <table>
    <tr>
      <td> 
<h3><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Residential Move</h3>
    <?php echo $this->Form->hidden('savelead_id', array('label'=>false, 'type'=>'text', 'value'=>$id)); ?>  
        ...
        <table class="content-table">
          ...
          <tr>
            ...
            <td><?php echo $this->Form->input('fname', array('label'=>false, 'type'=>'text')); ?></td>
          </tr>            <tr>
            <td><label for="name">Last name *:</label> </td>
            <td><?php echo $this->Form->input('lname', array('label'=>false, 'type'=>'text')); ?></td>
          </tr>            <tr>
            <td><label for="name">Best contact number *:</label> </td>
            <td><?php echo $this->Form->input('cellphone', array('label'=>false, 'type'=>'text')); ?></td>
          </tr>            <tr>
            <td><label for="name">Email address *:</label> </td>
            <td><?php echo $this->Form->input('email', array('label'=>false, 'type'=>'text')); ?></td>
          </tr>                             
          <tr>
